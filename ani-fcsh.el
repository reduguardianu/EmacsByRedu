...
(defvar *fcsh-path* "/opt/flexsdk/bin/fcsh" 
...
(defvar *fcsh-mxmlc-configuration-file* "build.xml" "Configuration file for mxmlc")

;; (defvar *fcsh-mxmlc-output-path* "..\\bin\\" 
...
(defvar *fcsh-mxml-file* "src/Main.as" 
